...
class Dataset(data.Dataset): 
    ...
    def __getitem__(self, index):
        ...
        whole_image = Image.open(whole_image_path).convert("RGB")
        image_array = np.asarray(whole_image)
        label_array = image_array[:, self.ori_size:, :]
        pixel_array = image_array[:, :self.ori_size, :]
